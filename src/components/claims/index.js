...
class Login extends Component {
  ...
  signInError(err) {
    ...
    console.info('sign in error', JSON.stringify(err));
  ...
  render() {
    const {
      ...
      user: { isLoadingUserClaims, isLoading, isLoadingUserGlobal },
    ...
    return (
      <div className="claims-rrgg-user-wrapper">
        <div className="claims-rrgg-user-top">
          ...
          <div className="claims-rrgg-user-top-desc">
            Sistema de Gestión de Siniestros RRGG
          </div>
        </div>
        <Spin
          spinning={isLoadingUserGlobal}
        >
          <div className="claims-rrgg-user-content">
            <div className="claims-rrgg-user-content-desc">
